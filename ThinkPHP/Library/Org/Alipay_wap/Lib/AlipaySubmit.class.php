<?php
namespace Org\Alipay_wap\Lib;
use Org\Alipay_wap\Lib\AlipayCore;
use Org\Alipay_wap\Lib\AlipayRsa;
/* *
 * 类名：AlipaySubmit
 * 功能：支付宝各接口请求提交类
 ...
 */
//require_once("alipay_core.class.php");
//require_once("AlipayRsa.class.php");
